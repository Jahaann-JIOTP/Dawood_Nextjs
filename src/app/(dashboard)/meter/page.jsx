...
const page = () => {
  ...
  return (
    ...
    <div className="relative w-full bg-white dark:bg-gray-800 overflow-x-hidden  p-5 rounded-md border-t-3 h-[81vh] border-[#1F5897]">
      <div className="flex items-center justify-between w-full">
        ...
        <button
          ...
          } gap-2 h-[40px] cursor-pointer bg-[#1F5897] transition-all duration-300 ease-in-out border-[3px] border-[#d8dfe7] dark:border-[#d8dfe738] text-white px-2 ${
